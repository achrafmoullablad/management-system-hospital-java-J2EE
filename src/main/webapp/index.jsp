				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure">2500</div>
						    </div><!--//app-card-body-->
				    ...
				    <div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure">58000</div>							   
						    </div><!--//app-card-body-->
					...
					<div class="col-6 col-lg-3">
					    <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    ...
							    <div class="stats-figure">560</div>							   
						    </div><!--//app-card-body-->
				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        ...
					        <div class="app-card-body p-3 p-lg-4">
						        ...
						        <div class="chart-container"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
				                    <canvas id="canvas-linechart" style="display: block; width: 454px; height: 302px;" width="454" height="302" class="chartjs-render-monitor"></canvas>
						        </div>
					        </div><!--//app-card-body-->
				        </div><!--//app-card-->
			        </div><!--//col-->
