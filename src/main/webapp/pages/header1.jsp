...
<head>
    ...
    <link rel="stylesheet" href="../assets/plugins/bootstrap/css/jquery.dataTables.css">
						        ...
						        <div class="dropdown-menu-content">
							       ...
							       <div class="item p-3">
								        <div class="row gx-2 justify-content-between align-items-center">
									        <div class="col">
										        <div class="info"> 
											        <div class="desc"> il y'a un Patient <%= p.getNom()+" "+p.getPrenom() %> qui Ajouter dans le cabinet </div>
										        </div>
									        </div><!--//col--> 
								        </div><!--//row-->
