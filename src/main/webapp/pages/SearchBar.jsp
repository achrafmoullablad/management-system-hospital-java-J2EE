...
<body class="app"> 
  ...
  <path fill-rule="evenodd" d="M8 5.754a2.246 2.246 0 1 0 0 4.492 2.246 2.246 0 0 0 0-4.492zM4.754 8a3.246 3.246 0 1 1 6.492 0 3.246 3.246 0 0 1-6.492 0z"/>
			            ...
			            <div class="app-utility-item app-user-dropdown dropdown">
				            ...
				            <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
								...
								<li><a class="dropdown-item" href="../disconnect.jsp">Log Out</a></li>
							</ul>
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
					    ...
					    <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="../Medecin.jsp">
						        <span class="nav-icon">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
		                         ...
		                         <span class="nav-link-text">Medecin</span>
					        </a> 
					      </li> 
					      <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
					      ...
					      <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="../Medicament.jsp">
						        <span class="nav-icon">
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
		                         ...
		                         <span class="nav-link-text">Medicament</span>
					        </a> 
					      </li>
					      <li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link" href="../Consulation.jsp">
						        <span class="nav-icon">
						        <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-card-list" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-13z"/>
  <path fill-rule="evenodd" d="M5 8a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7A.5.5 0 0 1 5 8zm0-2.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zm0 5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5z"/>
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
		                         ...
		                         <span class="nav-link-text">Consulation</span>
					        </a> 
					      </li>   
				    </ul><!--//app-menu-->
			    </nav><!--//app-nav-->
	   ...
	   <div class="container">
		...
		<%
			...
			if(search!=null){
				...
				Medecin lm=cm.SearchMedecin(search);
			
	    %>
			<div class="card p-3 m-3" style="width: 36rem;">
			  <div class="card-body">
					<h5 class="card-title">Information Medecin</h5>
					<p class="card-text">Nom :&nbsp&nbsp<%= lm.getNom() %></p>
					<p class="card-text">Prenom :&nbsp&nbsp<%= lm.getprenom() %></p>
					<p class="card-text">Email :&nbsp&nbsp<%= lm.getEmail() %></p>
					<p class="card-text">Adresse :&nbsp&nbsp<%= lm.getAdresse() %></p>
					<p class="card-text">Telephone :&nbsp&nbsp<%= lm.getTelephone() %></p>
					<a href="../ShowMedecin.jsp" class="btn btn-primary">Show All Medecin</a>
			  </div>
			</div>
		<% } else{
